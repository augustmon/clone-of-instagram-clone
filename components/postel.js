  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('circle', { cx: '6.5', cy: '11.5', r: '1.5', fill: 'var(--text-dark)' }),
          React.createElement('circle', { cx: '12', cy: '11.5', r: '1.5', fill: 'var(--text-dark)' }),
          React.createElement('circle', { cx: '17.5', cy: '11.5', r: '1.5', fill: 'var(--text-dark)' })
        )
      )
    ),
    React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('div', { 'class': 'post__indicators' }),
        React.createElement(
          'button',
          { 'class': 'post__button post__button--align-right' },
          React.createElement(
            'svg',
            {
              width: '24',
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'a',
              { 'class': 'post__name--underline', href: '#' },
              'user123'
            ),
            ' ',
            'and',
...
var rootNode = document.getElementById('post-root');
var root = ReactDOM.createRoot(rootNode);
root.render(React.createElement(React.createElement(Post, null)));